<?php
    ...
    $query = "UPDATE vest SET naslov='$naslov', vreme_postavljanja='$vreme_postavljanja', vreme_isticanja='$vreme_isticanja', tekst='$tekst', autor='$autor' WHERE id_vest='$id_vest' AND organizacija_id_organizacija='$id_organizacija'";

    if(mysqli_query($link, $query) === FALSE){
        $poruka = "Tražena vest ne postoji!";
